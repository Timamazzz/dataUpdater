"""
Django settings for dataUpdater project.
...
SECRET_KEY = 'django-insecure-o-k0o=8gv@b+i*l5)&j*1-efdzte!1i9mgczd)b+0ngpb&_s#_'
...
WSGI_APPLICATION = 'dataUpdater.wsgi.application'
